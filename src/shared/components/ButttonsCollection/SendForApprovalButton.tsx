...
const SendForApprovalButton = ({loading}:any) => {
    return (
        // <>
        //     <div className="flex justify-end mt-5">

        //         <button disabled={loading} className=" flex justify-center items-center bg-primaryColor font-bold text-sm text-white rounded-lg px-5   gap-2 py-3">
