...
export default function Location({ singleData, setsingleData }: any) {
  ...
  useEffect(() => {
    ...
    if (divisionId) {
      const objLoc = {
        ["parmanent.divisionId"]: divisionId,
        ["parmanent.districtId"]: districtId,
        ["parmanent.upazilaId"]: upazilaId,
        ["parmanent.villageName"]: villageName,
        ["parmanent.cityCorporationId"]: cityCorporationId,
        ["parmanent.postCode"]: postCode,
        ["parmanent.address"]: address,
        ["parmanent.wardName"]: wardName,
      };
      ...
      {selectedType === "Upazila" || upazilaId ? (
        ...
        <>
          ...
          <div className="relative">
            ...
            <select
              className="mt-1 block w-full p-4 border border-gray-300 rounded-md shadow-sm appearance-none"
              name="parmanent.cityCorporationId"
