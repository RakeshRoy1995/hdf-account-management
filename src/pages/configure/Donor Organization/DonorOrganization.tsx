...
const DonorOrganization = () => {
    ...
    const column = [
        ...
        {
            name: "action",
            cell: (row: any) => <>{ActionButton(fetchDataByID, row?.donorOrganizationId)}</>,
        },
    ];
    return (
        <div>
                        ...
                        <form action="submit" className="p-4 space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div className="flex flex-col relative">
                                    <label htmlFor="donorOrganizationName" className="text-sm absolute -mt-2 ml-4 mb-2 bg-white text-QuaternaryColor">Donor Organization Name</label>
                                    <input
                                ...
                                <div className="flex flex-col justify-between relative">
                                    <label htmlFor="status" className="text-sm absolute -mt-2 ml-4 mb-2 bg-white text-QuaternaryColor">Status</label>
                                    <div>
                                        <select
                                        ...
                                        >
                                            ...
                                            <option value="A" selected={singleData?.donorOrganizationRecStatus == "A"}>Active </option>
                                            <option value="I" selected={singleData?.donorOrganizationRecStatus == "I"}>Inactive</option>
                                        </select>
                                    </div>
