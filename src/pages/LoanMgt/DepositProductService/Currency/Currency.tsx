                    ...
                    <div className="grid grid-cols-2 gap-5 bg-white rounded-xl shadow-md p-10">
                        ...
                        <div className="flex flex-col relative mb-5">
                            ...
                            <input
                                ...
                                onInput={(e) => {
                                    ...
                                    if (!validSymbols.includes(inputValue) && inputValue.length > 0) {
                        ...
                        <div className="flex flex-col relative ">
                            ...
                            >
                                ...
                                <option value="A" selected={singleData?.currencyRecStatus == "A"}>Active </option>
                                <option value="I" selected={singleData?.currencyRecStatus == "I"}>Inactive</option>
                            </select>
