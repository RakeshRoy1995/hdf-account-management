...
const HolidaySetup = () => {
  ...
  return (
    <div>
      <BreadcumbWithButton name={"Holidays "} url={"/holiday-setup-add"} />
          ...
          <div className="p-5">
            <form className="p-4 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                {/* Holiday Name */}
                {/* <div className="flex flex-col relative">
                <label htmlFor="dateOfEffectiveness" className="text-sm  absolute -mt-2 ml-4 mb-2 bg-white text-QuaternaryColor">Holiday Name</label>
                <input
